...
\begin{bookbox}{}
    \textbf{对应正文：Example 3.6 (P206)}
    \\ 书中在演示完微分法后特别警告："for $k=0$, the term $jk\omega_0$ is zero... consequently, \textbf{$a_0$ must be calculated by inspection.}"
\end{bookbox}
...
\begin{tcolorbox}[colback=blue!5!white, colframe=blue!60!black, title= 记忆口诀]
